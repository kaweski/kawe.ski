...
(self.webpackChunkkaweski = self.webpackChunkkaweski || []).push([[787], { 787: function (e, t, n) { n.r(t), n.d(t, { getCLS: function () { return y; }, getFCP: function () { return g; }, getFID: function () { return F; }, getLCP: function () { return P; }, getTTFB: function () { return D; } }); var i, r, a, o, u = function (e, t) { return { name: e, value: void 0 === t ? -1 : t, delta: 0, entries: [], id: "v2-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 1e12) }; }, c = function (e, t) { try {
        ...
        } }, p = c("layout-shift", v); p && (n = m(i, r, t), f((function () { p.takeRecords().map(v), n(!0); })), s((function () { a = 0, T = -1, r = u("CLS", 0), n = m(i, r, t); }))); }, E = { passive: !0, capture: !0 }, w = new Date, L = function (e, t) { i || (i = t, r = e, a = new Date, b(removeEventListener), S()); }, S = function () { if (r >= 0 && r < a - w) {
        ...
        } }, b = function (e) { ["mousedown", "keydown", "touchstart", "pointerdown"].forEach((function (t) { return e(t, k, E); })); }, F = function (e, t) { var n, a = l(), v = u("FID"), p = function (e) { e.startTime < a.firstHiddenTime && (v.value = e.processingStart - e.startTime, v.entries.push(e), n(!0)); }, d = c("first-input", p); n = m(e, v, t), d && f((function () { d.takeRecords().map(p), d.disconnect(); }), !0), d && s((function () { var a; v = u("FID"), n = m(e, v, t), o = [], r = -1, i = null, b(addEventListener), a = p, o.push(a), S(); })); }, C = {}, P = function (e, t) { var n, i = l(), r = u("LCP"), a = function (e) { var t = e.startTime; t < i.firstHiddenTime && (r.value = t, r.entries.push(e), n()); }, o = c("largest-contentful-paint", a); if (o) {
            n = m(e, r, t);
            var v = function () { C[r.id] || (o.takeRecords().map(a), o.disconnect(), C[r.id] = !0, n(!0)); };
            ["keydown", "click"].forEach((function (e) { addEventListener(e, v, { once: !0, capture: !0 }); })), f(v, !0), s((function (i) { r = u("LCP"), n = m(e, r, t), requestAnimationFrame((function () { requestAnimationFrame((function () { r.value = performance.now() - i.timeStamp, C[r.id] = !0, n(!0); })); })); }));
